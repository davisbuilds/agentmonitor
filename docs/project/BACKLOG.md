...
- **What**: `amon costs repair-claude-usage` (shipped 2026-09-22 with the
  ...
  importer wrote.
- **Why or evidence**: the repair was **applied** to the development store on
  2026-09-22: 14,925 of 87,243 matched rows corrected, $2,465.32 and 3.59B
  tokens reclaimed, 25 summaries re-derived, total stored cost $24,777.45 to
  $22,342.15. What it could not reach remains: 284 ambiguous rows and **75,195
