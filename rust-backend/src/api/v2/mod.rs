...
pub fn router() -> Router<Arc<AppState>> {
    Router::new()
        ...
        .route("/analytics/summary", get(history::analytics_summary_handler))
        .route("/analytics/activity", get(history::analytics_activity_handler))
        .route("/analytics/projects", get(history::analytics_projects_handler))
