...
- Exposes event-derived Monitor migration endpoints under `/api/v2/monitor/*`, including event feed data, active session aggregates, and tool error-rate/duration analytics.
