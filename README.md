...
- Exposes event-derived Monitor migration endpoints under `/api/v2/monitor/*`, including active session aggregates plus tool error-rate and duration analytics.
