...
- Exposes event-derived Monitor migration endpoints under `/api/v2/monitor/*`, including summary stats, filter options, event feed data, active session aggregates, and tool error-rate/duration analytics.
