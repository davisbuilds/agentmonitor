...
- Exposes event-derived Monitor migration endpoints under `/api/v2/monitor/*`, including summary stats, event feed data, active session aggregates, and tool error-rate/duration analytics.
